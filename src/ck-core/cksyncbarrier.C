                                         ...
                                         int refcount)
{
  ...
  {
    // If the incoming client is ahead, then record those syncs and check the barrier. Do
    // this asynchronously so that the caller functions for object construction finish
    // first.
